...
public class TC_02_012  extends BaseTest
{
	...
	String text="Atrial Fibrillation (AF) is a common abnormal heart rhythm that happens when electrical impulses fire off from different places in the atria (the top chambers of the heart) in a disorganised way. This causes the atria to twitch, and is felt as an irregular heartbeat or pulse.";
	@Test
    ...
    act.moveToElement(glo.getAtrialFibrillation()).click();
    act.perform();
    
    String aorticStenosisText = glo.getAtrialFibrillationText().getText();
